...
def plot_results(output):
    ...
    for i, item in df.iterrows():
        ...
        plt.axis('off')
        q_img= imread(path+item[0])
        ss= resize(q_img,(256,256))
...
train_data, train_label = prep_data('train1')
# train_data= train_data.reshape(6,256,256,1)
train_data= train_data.reshape(6,256,256,3)

nb_epoch = 50
batch_size = 18
# history = autoencoder.fit(train_data, train_label, batch_size=batch_size, nb_epoch=nb_epoch, verbose=1)
autoencoder.save_weights('model_5l_weight_ep50.h5')

autoencoder.load_weights('/Users/Arsal/Downloads/keras-segnet-master/model_5l_weight_ep50.h5')

# Model visualization
# from keras.utils.visualize_util import plot
# plot(autoencoder, to_file='model.png', show_shapes=True)

test_data, test_label = prep_data('test1')
# test_data= test_data.reshape(15,256,256,1)
test_data= test_data.reshape(3,256,256,3)
...
print(output.shape)
plot_results(output)
# /Users/Arsal/Downloads/keras-segnet-master/Data/train/JPCLN001.jpg